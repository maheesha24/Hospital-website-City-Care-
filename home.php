      ...
      <div class="col-lg-5" data-aos="fade-up" data-aos-duration="1000">
        ...
        <div class="video-banner-layout2 bg-overlay">
          ...
          <div class="video-thumbnail">
            <img src="https://i.ytimg.com/vi/UIyvAmPFn8g/hqdefault.jpg?sqp=-oaymwEmCKgBEF5IWvKriqkDGQgBFQAAiEIYAdgBAeIBCggYEAIYBjgBQAE=\u0026rs=AOn4CLAIp5w1EWsZDfOpARiGB4B76oq4Ig" alt="about" class="w-100 img-thumbnail">
            <!-- Play Button Overlay -->
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/UIyvAmPFn8g" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-md-4 mb-4">
          <div class="card feedback-card" data-aos="fade-up" data-aos-duration="1000">
            ...
            <div class="card-body">
              <h5 class="card-title">Sasindu Dilshan</h5>
        ...
        <div class="col-md-4 mb-4">
          <div class="card feedback-card" data-aos="fade-up" data-aos-duration="1000">
            ...
            <div class="card-body">
              <h5 class="card-title">Sadeep Jayamal</h5>
        ...
        <div class="col-md-4 mb-4">
          <div class="card feedback-card" data-aos="fade-up" data-aos-duration="1000">
            ...
            <div class="card-body">
              <h5 class="card-title">Sahan jayanidu</h5>
